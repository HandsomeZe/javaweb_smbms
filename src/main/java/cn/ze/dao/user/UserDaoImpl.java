...
public class UserDaoImpl implements UserDao{
    ...
    public int updatePwd(Connection connection, int id, String password) throws SQLException {
        ...
        if (connection != null){
            ...
            flag = BaseDao.execute(connection, statement,sql,params);
            System.out.println("excute = " + flag);
    ...
    public int getUserCount(Connection connection,String name , int role) throws SQLException {
        ...
        if(connection!=null){
            ...
            System.out.println("usetDaoImpl->getUserCount"+sql.toString());


            rs = BaseDao.execute(connection,statement,rs,sql.toString(),params);
    ...
    public List<User> getUserList(Connection connection, String name, int role, int currentPageNo, int pageSize) throws Exception {
        ...
        if(connection != null){
            ...
            //  分页限制 limit startIndex , pageSize;
            /*
            *   0  5
            *   5  5
            *   10 5
